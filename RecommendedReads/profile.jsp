	            ...
	            <div class="profile-head">
	             <div class="profile-img">
	                ...
	                <ul class="nav nav-tabs" role="tablist">
	                    ...
	                    <li class="nav-item">
	                        <a class="nav-link" id="ratings-reviews-tab" data-toggle="tab" href="#ratings-reviews" role="tab" aria-controls="ratings-reviews" aria-selected="false">Ratings & Reviews</a>
	                    </li>
	                </ul>
	            </div>
			</div>
	                ...
	                <div class="tab-pane fade show active" id="account" role="tabpanel" aria-labelledby="account-tab">
	                	<div class="col-md-6">
	                   	...
	                   	<div class="btn-group edit-btn">
	           				<button class="w-10 btn btn-md btn-secondary" type="submit" onclick="window.location.href='edit_profile.jsp';">Edit Profile</button>
	         			</div>
	                </div>
	                <div class="tab-pane fade" id="ratings-reviews" role="tabpanel" aria-labelledby="ratings-reviews-tab">
	                	<div class="btn-group edit-btn">
	           				<button class="w-10 btn btn-md btn-secondary" type="submit" onclick="window.location.href='edit_ratings_reviews.jsp';">Edit</button>
	         			</div>
